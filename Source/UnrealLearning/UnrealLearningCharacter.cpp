...
void AUnrealLearningCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUnrealLearningCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUnrealLearningCharacter::TouchStopped);
...
void AUnrealLearningCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AUnrealLearningCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
